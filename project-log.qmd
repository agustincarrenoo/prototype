...
- Audited Wikidata item `Q138652613` against the official Sprengel Museum page.
- Confirmed instance, title, participant, curator, start and end dates, and official website; added source URL and retrieval-date references.
- Added the official Artist and Exhibition data-model mappings from the class project repository.
- Restored the SPARQL network visualization from the current course template.
- Added ORCID metadata to Quarto and the citation file.
- Documented AI-assistant use, benefits, limitations, and attribution.
...
- Added notebook-backed item profile page from the original template; it was later updated to `Q138652613`.
